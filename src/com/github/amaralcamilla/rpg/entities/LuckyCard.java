...
public class LuckyCard {
	...
	public LuckyCard(Player player, Enemy enemy) {
		...
		case 8:
		case 9: {
			System.out.println("\nVocê tomou um baita gole de uma poção maligna, suficiente para deixá-lo tonto. Você perdeu 15 de vida.");
		...
		case 11:
		case 12: {
			System.out.println("\nEita, que azar! Você perdeu seu amuleto da sorte e agora sua defesa está mais vulnerável.");
			player.getCombatClass().setDefense(player.getCombatClass().getDefense() - 3);
			break;
		}
		case 13: {
			System.out.println("Sorte grande!! Você tropeçou numa pedra rara com o número 13 inscrito. De agora em diante, 13 é o seu número da sorte, seu novo talismã! Você recuperou 20 pontos de vida.");
