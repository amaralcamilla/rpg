...
public class SceneMotivation extends Scene {
	...
	public SceneMotivation(Scanner keyboard) {
		...
		System.out.printf("%nBuscando uma injeção de ânimo, você se força a lembrar o que te trouxe até aqui.%n");
